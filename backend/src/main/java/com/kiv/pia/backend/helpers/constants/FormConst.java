...
public class FormConst {
    ...
    public static final String PASSWORD_REGEX = "^(?=.*\\d)(?=.*[a-z])(?=.*[A-Z]).{5,30}$";
    public static final String RE_ENTER_PASSWORD_REGEX = "^(?=.*\\d)(?=.*[a-z])(?=.*[A-Z]).{5,30}$";
    public static final String FIRST_NAME_REGEX = "^[a-zA-z]{3,30}$";
    public static final String LAST_NAME_REGEX = "^[a-zA-z]{3,30}$";
